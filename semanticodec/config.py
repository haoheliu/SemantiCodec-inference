def get_config(token_rate=100, vocab_size=None, checkpoint_path=None):
    assert vocab_size in [
        4096,
        8192,
        16384,
        32768,
    ], "vocab_size must be 4096, 8192, 16384 or 32768"
    ...
    if token_rate == 50:
        ...
        basic_config["model"]["params"]["cond_stage_config"][
            "crossattn_audiomae_pooled"
        ]["params"]["feature_dimension"] = (768 * 2)
    elif token_rate == 25:
        # modify context_dim
        ...
        basic_config["model"]["params"]["cond_stage_config"][
            "crossattn_audiomae_pooled"
        ]["params"]["feature_dimension"] = (768 * 4)
    elif token_rate == 100:
        pass
    else:
    ...
    feature_dim = basic_config["model"]["params"]["cond_stage_config"][
        "crossattn_audiomae_pooled"
    ]["params"]["feature_dimension"]
    lstm_layers = basic_config["model"]["params"]["cond_stage_config"][
        "crossattn_audiomae_pooled"
    ]["params"]["lstm_layer"]
    return (
        basic_config,
        ...
        feature_dim,
        lstm_layers,
        semantic_codebook[token_rate][vocab_size],
    )
